...
export default function StateHub() {
  ...
  useHead({
    title: `Ice Skating Rinks in ${state}`,
    description: `Find ice rinks, public skating, and freestyle sessions in ${state}.`
  });
    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 py-20 text-center">
                <h1 className="text-3xl font-serif mb-4">No rinks found for {state}</h1>
    ...
    <Layout>
       <div className="bg-muted/30 border-b">
        <div className="container mx-auto px-4 py-12">
          ...
          <h1 className="font-serif text-4xl font-bold mb-4">Ice Skating in {state}</h1>
          <p className="text-muted-foreground max-w-2xl">
            Complete directory of ice skating facilities across {state}.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <h2 className="font-serif text-2xl font-bold mb-6">All Rinks in {state}</h2>
